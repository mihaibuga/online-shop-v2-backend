        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductAttributeType = table.Column<string>(type: "nvarchar(21)", maxLength: 21, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "StockInventoryTransactions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockInventoryTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockInventoryTransactions_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockInventoryTransactions_ProductVariantId",
